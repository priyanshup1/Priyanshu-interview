        ...
        <section className="text-gray-200 body-font relative">
            <div className="container px-5 py-11 mx-auto">
                <div className="flex flex-col text-center w-full mb-12">
                    ...
                    <p className="note lg:w-2/3 mx-auto leading-relaxed text-base">
                        NOTE : Please enter the right email address to get Response for Valuable info!!!</p>
                </div>
                        ...
                        <form ref={form} onSubmit={sendEmail} className="flex flex-wrap -m-2">
                            ...
                            <div className="p-2 w-1/2">
                                <div className="relative">
                                        ...
                                        <input class="aj w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300
                            ...
                            <div className="p-2 w-1/2">
                                <div className="relative">
                                    ...
                                    <input className="aj w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300
                                                        focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none
                                                        text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                            ...
                            <div className="p-2 w-full">
                                <div className="relative">
                                        ...
                                        <textarea class="aj w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500
                            ...
                            <div className="p-2 w-full">
                            <input className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8
                                               focus:outline-none hover:bg-indigo-600 rounded text-lg"
                                   type="submit" value="Send" onClick={notify}/>
                            </div>
                        </form>
                        <div className="p-2 w-full pt-4 mt-4 border-t border-gray-100 text-center">
                            <p className="leading-normal my-3">49 Smith St.
